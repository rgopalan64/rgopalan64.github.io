pmlproject3 <- function(directory) {
  ...
  ## the location of the CSV files (the directory where the action takes place)
  ...
  # PLOT VARS IN THE SMALLER TESTING DATA SET
  print(qplot(accel_arm_x, magnet_arm_x, color = newclasse, data = testing))
  print(qplot(magnet_belt_y, newclasse, color = newclasse, data = testing))
